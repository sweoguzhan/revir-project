...
const UserEntryForm: FC<{selectedProject: Project}> = ({selectedProject}) => {
	...
	const postData = async () => {
		...
		sendForm({
			...
			if (response.status === 'success') {
				void Swal.fire({
					title: 'Başarılı',
					text: 'Başarıyla giriş formu gönderildi.',
					icon: 'success',
				...
				<div className='modal-dialog'>
					<div className='modal-content'>
						<div className='modal-header'>
							<h5 className='modal-title'>Giriş Formu Gönder</h5>
							<div
