...
const ChartsWidget3: React.FC<Props> = ({className, statData, loading}) => {
    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Hasta</span>

          <span className='text-muted fw-semibold fs-7'>Hasta istatistikleri</span>
        </h3>
